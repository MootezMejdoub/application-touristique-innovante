...
/**
 * @extends ServiceEntityRepository<CommentDislike>
 *
...
class CommentDislikeRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(CommentDislike $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(CommentDislike $entity, bool $flush = true): void
    {
