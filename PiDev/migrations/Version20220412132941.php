 ...
 */
final class Version20220412132941 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reponse ADD CONSTRAINT FK_5FB6DEC7ACAEE414 FOREIGN KEY (rec_reference) REFERENCES reclamation (rec_reference) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE reponse ADD CONSTRAINT FK_5FB6DEC71669B19B FOREIGN KEY (rec_id) REFERENCES reclamation (id) ON DELETE CASCADE');
